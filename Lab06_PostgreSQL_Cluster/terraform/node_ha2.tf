resource "proxmox_vm_qemu" "lab06-ha-node2" {
    name = "lab06-ha-node2"
    description = "lab06-ha-node2"
    ...
    # Lan2: internal network (keepalived net)
    network {
        id = 1
        model = "virtio"
        bridge = "vmbr6"
