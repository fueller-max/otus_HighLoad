resource "proxmox_vm_qemu" "lab06-pg-node1" {
    name = "lab06-pg-node1"
    description = "lab06-pg-node1"
    ...
    # Lan2: internal network (cluster net)
    network {
        id = 1
        model = "virtio"
        bridge = "vmbr7"
