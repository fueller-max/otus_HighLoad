resource "proxmox_vm_qemu" "lab08-es-node1" {
    name = "lab08-es-node1"
    description = "lab08-es-node1"
    ...
    # Lan2: internal network (es <-> logstash, kibana)
    network {
        id = 1
        model = "virtio"
        bridge = "vmbr5"
