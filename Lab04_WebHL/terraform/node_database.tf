resource "proxmox_vm_qemu" "lab04-database" {
    name = "lab04-database"
    description = "lab04_database"
    ...
    # Lan2: internal network (database <-> backend)
    network {
        id = 1
        model = "virtio"
        bridge = "vmbr3"
