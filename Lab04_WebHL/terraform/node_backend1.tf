resource "proxmox_vm_qemu" "lab04-backend1" {
    name = "lab04-backend1"
    description = "lab04_backend1"
    ...
    ipconfig0 = "ip=192.168.70.43/24,gw=192.168.70.1"
    nameserver = "8.8.8.8"
    ciuser = "deploy"
    sshkeys = <<EOF
       ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEwOGqPyDBruydkg1DPItwaBBwo5/5gAaBYeshgNFmlS maksim@maksim-asus-tuf
     EOF
    ipconfig1 = "ip=10.10.20.43/24"
    ipconfig2 = "ip=10.10.30.43/24"
    ipconfig3 = "ip=10.10.40.43/24"
